...
2. Visit the link:https://github.com/kazurayam/junit4ks/releases/tag/1.6.3[Releases v1.6.3] page. Locate the link `injectJunit4ks-build.gradle`. Download the file into your project's root directory.
